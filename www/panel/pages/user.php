	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6 col-xs-12">
				...
				<div class="form-group-sm">
					<label for="profile-color"><h3>Цвет</h3></label>
					<input type="color" name="color" id="profile-color" class="form-control" style="padding:2px;display:block;width:30px;height:30px;" value="<?php echo !empty($userProfile->color) ? $userProfile->color : '#ffffff';?>">
				</div>				
			</div>
			<?php } ?>
		</div>
