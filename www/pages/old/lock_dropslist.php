						...
						<div class="content">
							...
							<div class="row">
								...
								<div class="col-xs-12">
									...
									<div class="checkbox"><label><input type="checkbox" checked=""> Отослаь сотруднику</label></div>
								</div>
							</div>
						</div>
...
<table class="table table-striped">
	<thead>
		<tr>
			<th>Имя</th>
			<th>Страна</th>
			<th align="center" class="text-center">Завершено / В работе</th>
			...
			foreach($usersList as $k=>$v) {
				?>
					<tr data-user-id="<?php echo $v->id;?>">
						...
						<td align=center><?php echo getDropCompleatePkgs($v->id).'/'.getDropInworkPkgs($v->id); ?></td>
						<?php if ($user['rankname']=='admin' || $user['rankname']=='support') { ?>
						...
						<td class="text-center">
							...
							?>
								...
								&nbsp;|&nbsp;
								<a href="javascript:void(0);" onclick="deleteUser(<?php echo $v->id;?>);"><i class="fa  fa-lg fa-times text-danger"  data-toggle="tooltip" data-placement="top" title="Delete user"></i></a>
							<?php } else { ?>
